...
final class observer_test extends \advanced_testcase {
    ...
    public function test_calendar_event_created_course_event(): void {
        ...
        // Assert that the event was logged in local_icalsender_ics_event_log.
        $log = $DB->get_record('local_icalsender_ics_event_log', ['eventid' => $eventid]);
        $this->assertNotEmpty($log, 'Event should be logged in local_icalsender_ics_event_log');
    ...
    public function test_calendar_event_deleted_course_event(): void {
        ...
        $DB->insert_record('local_icalsender_ics_event_log', [
            'eventid' => $eventid,
        ...
        $logexists = $DB->record_exists('local_icalsender_ics_event_log', ['eventid' => $eventid]);
        $this->assertFalse($logexists, 'Event should be deleted from local_icalsender_ics_event_log');
    }
    ...
    public function test_calendar_event_updated_course_event(): void {
        ...
        $newseq = $DB->get_field('local_icalsender_ics_event_log', 'seqnum', ['eventid' => $eventid]);
